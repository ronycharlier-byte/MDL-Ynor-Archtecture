...
- Le noyau `04_X_NOYAU_MEMOIRE` dispose d'une entree lisible via `09_A_PRIME_TRANSMISSION_STAGE_STEP_14_MASTER_FINAL_JSON_9FFE52.md`.
...
- Dans certaines branches, le bruit vient surtout des copies textuelles automatiques de fichiers binaires, des `09_A_PRIME_MIROIR_OMEGA_PORTAIL_EDITION_MIROIR_TEXTUEL_MASTER_FINAL_04_06_MD.md`, des `../../../02_B_THEORIE_ET_PREUVES/09_PDF_CONSTITUTION_MATH_AUGMENTES/MDL_Ynor_Framework/03_C_CONSTITUTION_B_THEORIE_PREUVES_PDF_3_FRACTALE_E3672E.md`, des `09_A_PRIME_TRANSMISSION_STAGE_STEP_14_MASTER_FINAL_JSON_9FFE52.md` et des `09_A_PRIME_TRANSMISSION_STAGE_STEP_14_MASTER_FINAL_JSON_9FFE52.md`.
