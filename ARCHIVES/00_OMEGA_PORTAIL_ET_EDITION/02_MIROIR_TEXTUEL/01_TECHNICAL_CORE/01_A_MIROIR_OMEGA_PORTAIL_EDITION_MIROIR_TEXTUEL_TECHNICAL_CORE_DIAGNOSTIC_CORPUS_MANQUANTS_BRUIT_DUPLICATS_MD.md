...
- Familles historiquement prioritaires a dedoublonner logiquement:
 - `01_A_MIROIR_OMEGA_PORTAIL_EDITION_MIROIR_TEXTUEL_TECHNICAL_CORE_PROTOCOLES_YNOR_MD.md` comme source unique pour la famille `PROTOCOLES_*`.
 - `01_A_MIROIR_OMEGA_PORTAIL_EDITION_MIROIR_TEXTUEL_TECHNICAL_CORE_AXIOMES_YNOR_MD.md` comme source unique pour la famille `AXIOMES_*`.
 - `Procfile`, `01_A_MIROIR_OMEGA_PORTAIL_EDITION_MIROIR_TEXTUEL_TECHNICAL_CORE_YNOR_ACADEMIC_META_JSONLD.md`, `01_A_MIROIR_YNOR_FRAMEWORK_VISUAL_PREVIEW_TECHNICAL_CORE_6B16F3.md`, `MDL_Ynor_Dynamic_Systems_Paper.tex`, `MDL_Ynor_NeurIPS_Submission.tex` et `../../../03_C_MOTEURS_ET_DEPLOIEMENT/01_SOURCE_IMPLANTEE/MDL_Ynor_Framework/_03_CORE_AGI_ENGINES/MDL_YNOR_GPT_KNOWLEDGE/04_D_CENTRE_DOCTRINAL_C_MOTEURS_DEPLOIEMENT_SOURCE_GLOBAL_KNOWLEDGE_B0873F.json` comme couples ou miroirs a maintenir en archive uniquement.
 - Les exports `*01_A_MIROIR_YNOR_FRAMEWORK_VISUAL_PREVIEW_TECHNICAL_CORE_6B16F3.md`, `*.fractale_augmente.tex`, `*09_A_PRIME_TRANSMISSION_STAGE_STEP_14_MASTER_FINAL_JSON_7116ED.md` et `*01_A_MIROIR_OMEGA_PORTAIL_EDITION_MIROIR_TEXTUEL_TECHNICAL_CORE_04_06_MD.md` comme artefacts derives, jamais comme lecture principale.
...
- La carte canonique des doublons est disponible dans [01_A_MIROIR_OMEGA_PORTAIL_EDITION_MIROIR_TEXTUEL_TECHNICAL_CORE_CANONICAL_CONSOLIDATION_CERTIFICATE_MD.md](../00_EDITION_CANONIQUE_FINALE/09_A_PRIME_MIROIR_OMEGA_PORTAIL_EDITION_MIROIR_TEXTUEL_EDITION_CANONIQUE_FINALE_CANONICAL_DUPLICATES_MAP_MD.md).
