...
01_A_A_MIROIR_OMEGA_PORTAIL_EDITION_MIROIR_TEXTUEL_TECHNICAL_CORE_PROTOCOLES_FEUILLES_YNOR_MD.md` comme source unique pour la famille `PROTOCOLES_*`.
01_A_A_MIROIR_OMEGA_PORTAIL_EDITION_MIROIR_TEXTUEL_TECHNICAL_CORE_AXIOMES_YNOR_MD.md` comme source unique pour la famille `AXIOMES_*`.
01_A_A_MIROIR_OMEGA_PORTAIL_EDITION_MIROIR_TEXTUEL_TECHNICAL_CORE_YNOR_ACADEMIC_META_JSONLD.md01_A_A_MIROIR_OMEGA_PORTAIL_EDITION_MIROIR_TEXTUEL_TECHNICAL_CORE_LICENSE_MD.md01_A_A_MIROIR_OMEGA_PORTAIL_EDITION_MIROIR_TEXTUEL_TECHNICAL_CORE_LICENSE_MD.md` comme couples ou miroirs a maintenir en archive uniquement.
01_A_A_MIROIR_OMEGA_PORTAIL_EDITION_MIROIR_TEXTUEL_TECHNICAL_CORE_04_06_MD.md09_A_PRIME_A'_TRANSMISSION_STAGE_STEP_14_MASTER_FINAL_JSON_7116ED.md01_A_A_MIROIR_OMEGA_PORTAIL_EDITION_MIROIR_TEXTUEL_TECHNICAL_CORE_04_06_MD.md01_A_A_MIROIR_OMEGA_PORTAIL_EDITION_MIROIR_TEXTUEL_TECHNICAL_CORE_04_06_MD.md.md` comme artefacts derives, jamais comme lecture principale.
...
- La carte canonique des doublons est disponible dans [01_A_A_MIROIR_OMEGA_PORTAIL_EDITION_MIROIR_TEXTUEL_TECHNICAL_CORE_04_06_MD.md](../00_EDITION_CANONIQUE_FINALE/09_A_PRIME_A'_MIROIR_OMEGA_PORTAIL_EDITION_MIROIR_TEXTUEL_EDITION_CANONIQUE_FINALE_CANONICAL_DUPLICATES_MAP_MD.md).
