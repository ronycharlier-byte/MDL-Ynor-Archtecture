...
```bash
02_B_B_CONSTITUTION_FONDATION_SOURCE_IMPLANTEE_MDL_YNOR_FRAMEWORK_YNOR_FULL_CORPUS_FORMAL_SPEC_V2_3.md
pip install -e .
```
...
02_B_B_CONSTITUTION_FONDATION_SOURCE_IMPLANTEE_MDL_YNOR_FRAMEWORK_YNOR_FULL_CORPUS_FORMAL_SPEC_V2_3.md` for licensing specifications and reproducible subset access.
