...
foreach ($node in $nodes) {
 ...
 Set-Content -Path (Join-Path $nodeRoot "02_B_MIROIR_FONDATION_MIROIR_TEXTUEL_MDL_YNOR_CONSTITUTION_BUILD_FRACTAL_CHIASM_PY.md") -Value $nodeReadme -Encoding UTF8
 ...
 Set-Content -Path (Join-Path $mirrorRoot "02_B_MIROIR_FONDATION_MIROIR_TEXTUEL_MDL_YNOR_CONSTITUTION_BUILD_FRACTAL_CHIASM_PY.md") -Value $mirrorNote -Encoding UTF8
 ...
 Set-Content -Path (Join-Path $recursionRoot "../../../00_OMEGA_PORTAIL_ET_EDITION/03_RECURSION/01_A_MIROIR_OMEGA_PORTAIL_EDITION_RECURSION_RECURSION.txt") -Value $recursionNote -Encoding UTF8
...
Set-Content -Path (Join-Path $outputRoot "02_B_MIROIR_FONDATION_MIROIR_TEXTUEL_MDL_YNOR_CONSTITUTION_BUILD_FRACTAL_CHIASM_PY.md") -Value ($manifestLines -join "`r`n") -Encoding UTF8

$jsonNodes | ConvertTo-Json -Depth 5 | Set-Content -Path (Join-Path $outputRoot "02_B_MIROIR_FONDATION_MIROIR_TEXTUEL_MDL_YNOR_CONSTITUTION_BUILD_FRACTAL_CHIASM_PY.md") -Encoding UTF8
