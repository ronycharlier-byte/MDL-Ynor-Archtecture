 ...
 *[f"- {name}" for name in copied_names],
 ...
 (node_root / "02_B_MIROIR_FONDATION_MIROIR_TEXTUEL_MDL_YNOR_CONSTITUTION_BUILD_FRACTAL_CHIASM_PY.md").write_text(node_readme, encoding="utf-8")
 ...
 (mirror_root / "02_B_MIROIR_FONDATION_MIROIR_TEXTUEL_MDL_YNOR_CONSTITUTION_BUILD_FRACTAL_CHIASM_PY.md").write_text(mirror_note, encoding="utf-8")
 ...
 (recursion_root / "../../../00_OMEGA_PORTAIL_ET_EDITION/03_RECURSION/01_A_MIROIR_OMEGA_PORTAIL_EDITION_RECURSION_RECURSION.txt").write_text(recursion_note, encoding="utf-8")
 ...
 (output_root / "02_B_MIROIR_FONDATION_MIROIR_TEXTUEL_MDL_YNOR_CONSTITUTION_BUILD_FRACTAL_CHIASM_PY.md").write_text(
 "\n".join(manifest_lines),
 encoding="utf-8",
 )
 (output_root / "02_B_MIROIR_FONDATION_MIROIR_TEXTUEL_MDL_YNOR_CONSTITUTION_BUILD_FRACTAL_CHIASM_PY.md").write_text(
