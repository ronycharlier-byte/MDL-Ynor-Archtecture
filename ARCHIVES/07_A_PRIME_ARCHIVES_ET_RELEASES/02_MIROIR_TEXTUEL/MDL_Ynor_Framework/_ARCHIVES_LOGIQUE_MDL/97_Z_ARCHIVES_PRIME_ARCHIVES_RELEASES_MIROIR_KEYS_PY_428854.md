...
KEYS_FILE = os.path.join(os.path.dirname(__file__)97_Z_ARCHIVES_PRIME_ARCHIVES_RELEASES_MIROIR_KEYS_PY_428854.md")
...
def validéte_api_key(api_key: str, endpoint: str) -> dict:
 """
