...
# Sovereign_Millennium_Dissipative_Stability_Proof - VERSION FRACTALE ET CHIASTIQUE
...
## C. Matiere
% ----------------------- PACKAGES ------------------------------------ \usepackage[utf8]{inputenc} \usepackage[T1]{fontenc} \usepackage{amsmath, amssymb, amsthm} \usepackage{geometry} \usepackage{cite} \usepackage{hyperref} \usepackage{mathrsfs} \usepackage{enumitem}
