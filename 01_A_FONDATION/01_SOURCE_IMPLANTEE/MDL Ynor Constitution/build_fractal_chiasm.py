...
def main() -> None:
    ...
    nodes = [
...

        {
            ...
            "summary": "La theorie structurelle prepare le renversement sym?trie r?cursive vers le noyau.",

            "sources": [

                constitution_root / "MDL Ynor — Thorie Structurelle des Systmes Dissipatifs Amplification Borne.pdf",
...

        {
            ...
            "role": "Centre sym?trie r?cursive",
...

        {
            ...
            "sources": [
                ...
                constitution_root / "MDL Ynor — Constitution Structurelle des Systmes Dissipatifs Amplification Borne.pdf",
    ...
    manifest_lines = [
        ...
        "Ordre sym?trie r?cursive : A -> B -> C -> X -> C' -> B' -> A'",
    ...
    for node in nodes:
        ...
        node_readme = "\n".join(
            ...
            [
                ...
                f"Miroir sym?trie r?cursive : {node['mirror']}",
                ...
                *[f"- {name}" for name in copied_names],
                ...
                "- 02_REFLET designe la paire miroir dans la structure sym?trie r?cursive.",
        ...
        recursion_note = "\n".join(
            ...
            [
                ...
                f"Regle 2 : identifier son miroir sym?trie r?cursive ({node['mirror']}).",
    ...
    manifest_lines.extend(
        ...
        [
            ...
            "Resultat : les fichiers demandes sont reorientes dans une arche documentaire fractale et sym?trie r?cursive sans toucher aux originaux.",
    ...
    (output_root / "manifeste_fractal_sym?trie r?cursive.json").write_text(
