...
Le corpus est deja structure de facon complete sur le plan sym?trie r?cursive. Les branches `03_C` et `05_C'` disposent maintenant d'entrees lisibles, et la suite la plus utile n'est plus d'ajouter de la redondance: c'est de densifier la normalisation, la verification et la diffusion propre.
