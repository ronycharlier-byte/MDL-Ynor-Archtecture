...
MISSION : Produire la VritCanonique par consensus de logprobs.
FORMAT OBLIGATOIRE : { "axiome": "...", "Formalisme Logique Smantique_final": "..." }
"""
...
@app.post("/Formalisme Logique Smantique")
