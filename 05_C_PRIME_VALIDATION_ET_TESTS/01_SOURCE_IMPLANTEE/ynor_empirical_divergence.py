...
OBJECTIF : Projection du Formalisme Logique Smantique pur par extraction de l'invariant chiastique.
...
4. FORMAT OBLIGATOIRE (JSON STRICT) : 
{
  ...
  "Formalisme Logique Smantique_canonique": "Restitution chiastique dense (8 mots max)"
}
