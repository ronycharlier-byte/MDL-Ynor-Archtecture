...
<body>
    ...
    <div class="grid">
        ...
        <div class="card" id="mu-card">
            ...
            <div class="metric-sub" id="mu-status">L'agent gnre des tokens valides.</div>
        ...
        <div class="card">
            ...
            <div class="metric-sub">Économiscontre les hallucinations</div>
        ...
        <div class="card">
            ...
            <div style="display:flex; justify-content: space-between; margin-top: 1rem;">
                ...
                <div>
                    ...
                    <div style="font-size:0.75rem; color:var(--text-muted)">Systme 1 (Heuristique)</div>
                ...
                <div>
                    ...
                    <div style="font-size:0.75rem; color:var(--text-muted)">Systme 2 (Correction)</div>
    ...
    <div class="log-container" id="terminal-logs">
        ...
        <div class="log-entry"><span class="log-time">[SYSTEM]</span> Initialisation Console Ynor... Prêt. Trafic API dynamique dtect.</div>
    ...
    <script>
        ...
        // Simulation en temps rel des mtriques Ynor
        ...
        function updateDashboard() {
            ...
            // Gnrer de nouvelles valeurs alatoires pour simuler l'quation Ynor
            ...
            if (mu < 0) {
                ...
                muStatus.innerText = "ALERTE: Divergence dtecte. Requête coupe.";
                ...
                newLog.innerHTML = `<span class="log-time">[${timeStr}]</span> <span class="log-crit">[INTERVENTION SYSTEM 2]</span> μ = ${mu}. Hallucination prvenue. Token API prservs (Sauv: $${savedThisTime}).`;
                ...
                muStatus.innerText = "L'agent gnre des tokens valides.";
        ...
        // Lancer la boucle de simulation en temps rel (entre 800ms et 2500ms)
