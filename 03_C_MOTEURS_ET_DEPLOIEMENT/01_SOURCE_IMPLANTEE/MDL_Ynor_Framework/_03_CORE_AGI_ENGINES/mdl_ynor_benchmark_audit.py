...
def run_benchmark_implementation():
    ...
    ax1.set_xlabel('ComplexitAnalytique (α)')


    ax1.set_ylabel('FragilitConceptuelle (β)')
    ...
    ax2.plot(t, mu_robust, color='#33cc33', label='Problme Robuste (μ > 0)', linewidth=2)


    ax2.plot(t, mu_fragile, color='#ff3333', label='Problme Fragile (μ < 0)', linewidth=2)
    ...
    ax2.set_xlabel('Temps de Rsolution / Itrations')
    ...
    print(f"\n[OK] Visualisation de l'Audit Mu gnre : {output_path}")
