...
# VISUALISATIONS (Portraits de phase structurs)
...
def plot_phase_portrait_alpha_beta(
    ...
    plt.title("Ynor Ω+ : Espace Vectoriel & Trajectoires de Viabilit(Plan α-β)")
    ...
    print(f"[OK] Portrait de Phase (α vs β) gnr: {output}")
...
def plot_phase_portrait_alpha_kappa(
    ...
    plt.ylabel("κ (Charge Mnsique et Contexte)")


    plt.title("Ynor Ω+ : Espace Vectoriel & Trajectoires de Viabilit(Plan α-κ)")
    ...
    print(f"[OK] Portrait de Phase (α vs κ) gnr: {output}")
...
if __name__ == "__main__":
    ...
    initial_conditions = [
        ...
        (0.3, 2.2, 1.7),  # Haut Coût, Haute Mmoire


        (0.5, 1.5, 1.0),  # Stress Modr


        (1.2, 0.9, 0.8),  # Information Stable


        (2.0, 0.5, 0.3),  # Idal : Haute Info, Bas Bruit
