...
# Ce script prpare votre dossier d'upload pour le GPT Store en :


# 1. Masquant les informations personnelles (emails, chemins)


# 2. Renommant les fichiers avec des noms alatoires


# 3. Crant une archive propre pour l'upload final
...
EMAIL_REGEX = r"[a-zA-Z0-9._%+-]+@mdlstrategy\.[a-zA-Z0-9.-]+" # Cible spcifique MDL
...
def redact_content(content):
    ...
    # Autres remplacements de scurit(codes sha, etc.)
...
def obfuscate_and_clean():
    ...
    for filename in os.listdir(SOURCE_DIR):
        ...
        # Gnrer un nouveau nom (UUID + extension originale ou .bin)
        ...
        try:
            ...
            # Copie brute si chec de lecture texte (pdf, etc.)
    ...
    # Sauvegarder le mapping pour le crateur
