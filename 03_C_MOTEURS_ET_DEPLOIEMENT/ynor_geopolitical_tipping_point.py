...
def run_geopolitical_simulation():
    ...
    print("OBJET : Conflit Iran-USA — Analyse de Saturation et Rsonance Spectral ($\Lambda$)")
    print("------------------------------------------------------------------------------")
    
    # 1. Modlisation de la Matrice Chiastique (A-B Interaction)
    # A : Iran (Expansion Fractale / Asymtrie)
    # B : USA (Force Linaire / Projection de Puissance)
