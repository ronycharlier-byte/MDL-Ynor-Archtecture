...
```text
{
  "hypotheses": {
    ...
    "initial_data": "u0 in H^s(Canonique), s > 5/2, div u0 = 0",
    "continuation_condition": "Integrability of the L-infinity norm of vorticity: integral_0^T ||canonique(t)||_{L-inf} dt < inf"
  },
  ...
  "points_non_demonstrated": [
    "Uniform global bound on ||canonique(t)||_{L-inf} for arbitrary large initial data (The Millennium Problem)",
