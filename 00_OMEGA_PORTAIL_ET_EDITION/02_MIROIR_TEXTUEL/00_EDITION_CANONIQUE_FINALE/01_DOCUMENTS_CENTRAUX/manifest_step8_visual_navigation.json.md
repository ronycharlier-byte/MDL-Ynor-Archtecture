# MIROIR TEXTUEL - manifest_step8_visual_navigation.json
...
```text
{
  ...
  "navigation": {
    ...
    "03_C_MOTEURS_ET_DEPLOIEMENT": {
      "title": "C | Moteurs et deploiement",
      "count": 0,
      "top_sources": []
    },
    "04_X_NOYAU_MEMOIRE": {
      "title": "X | Noyau memoire",
      "count": 8,
      "top_sources": [
    ...
    "05_C_PRIME_VALIDATION_ET_TESTS": {
      "title": "C' | Validation et tests",
      "count": 0,
      "top_sources": []
    },
    "06_B_PRIME_GOUVERNANCE_ET_DIFFUSION": {
      "title": "B' | Gouvernance et diffusion",
      "count": 43,
      "top_sources": [
