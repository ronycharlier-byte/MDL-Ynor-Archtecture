# MIROIR TEXTUEL - DISCUSSION_BOHR_CALCULEE.md
...
**IA :** Elle n'est pas decrite comme un objet classique porteur de proprietes déjà definies de facon complete. La theorie parle d'etats, de superposition et de resultats possibles. La mesure ne cree pas une illusion subjective : elle fixe un resultat dans un cadre experimental precis.
