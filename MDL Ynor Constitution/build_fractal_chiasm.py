...
def main() -> None:
    ...
    nodes = [

        {
            ...
            "summary": "Le point d'entrée du systeme. Les axiomes minimaux ouvrent la forme fractale.",
...

        {
            ...
            "sources": [
                ...
                constitution_root / "MDL Ynor — Thormes fondamentaux de la marge dissipative.pdf",
...

        {
            ...
            "summary": "La theorie structurelle prepare le renversement symétrie r?cursive vers le noyau.",

            "sources": [

                constitution_root / "MDL Ynor — Thorie Structurelle des Systèmes Dissipatifs Amplification Borne.pdf",
...

        {
            ...
            "role": "Centre symétrie r?cursive",
            ...
            "sources": [
                ...
                constitution_root / "MDL Ynor MATH" / "Chapitre XVI — Formalisation mathmatique intgrale du noyau MDL Ynor.pdf",

                constitution_root / "Chapitre I — Formalisation mathmatique intgrale du noyau MDL Ynor.pdf",
...

        {
            ...
            "sources": [
                ...
                constitution_root / "MDL Ynor — Constitution Structurelle des Systèmes Dissipatifs Amplification Borne.pdf",
...

        {
            ...
            "sources": [
                ...
                constitution_root / "MDL Ynor — Traitdes dynamiques dissipatives et de la stabilitstructurelle.pdf",
    ...
    manifest_lines = [
        ...
        "Ordre symétrie r?cursive : A -> B -> C -> X -> C' -> B' -> A'",
    ...
    for node in nodes:
        ...
        node_readme = "\n".join(
            ...
            [
                ...
                f"Miroir symétrie r?cursive : {node['mirror']}",
                ...
                *[f"- {name}" for name in copied_names],
                ...
                "- 02_REFLET designe la paire miroir dans la structure symétrie r?cursive.",
        ...
        recursion_note = "\n".join(
            ...
            [
                ...
                f"Regle 2 : identifier son miroir symétrie r?cursive ({node['mirror']}).",
    ...
    manifest_lines.extend(
        ...
        [
            ...
            "Resultat : les fichiers demandes sont reorientes dans une arche documentaire fractale et symétrie r?cursive sans toucher aux originaux.",
    ...
    (output_root / "manifeste_fractal_symétrie r?cursive.json").write_text(
