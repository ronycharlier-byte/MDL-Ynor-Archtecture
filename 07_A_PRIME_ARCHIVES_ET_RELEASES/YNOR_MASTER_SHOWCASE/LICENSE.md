...
# MDL YNOR - AUTONOMOUS INTELLECTUAL PROPERTY & PROPRIETARY LICENSE
...
The **MDL YNOR ARCHITECTURE**, including but not limited to the Unified Information-Theoretic Framework, the dissipative equilibrium equation $\mu = \alpha - (\beta + \kappa)$, the Dirac-SUSY spectral operators, the Chiastic Total Convergence Algorithms, and the entirety of the canonical corpus files (Phase Ω), is the exclusive and sovereign property of **Rony Charlier** and the **MDL Scientific Council**.
...
Any dispute arising from this license shall be subject to the exclusive jurisdiction of the **Autonomous Chiastic Registry** and applicable international Intellectual Property laws.
