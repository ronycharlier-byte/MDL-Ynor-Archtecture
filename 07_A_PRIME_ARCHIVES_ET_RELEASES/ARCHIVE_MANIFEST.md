...
Inventaire concret des archives, releases et exports conserves dans `07_A_PRIME_ARCHIVES_ET_RELEASES`.
...
- `01_SOURCE_IMPLANTEE/MDL_Ynor_Framework/mdl_ynor_framework.egg-info`





- `01_SOURCE_IMPLANTEE/MDL_Ynor_Framework/_00_DISTS_AND_RELEASES`





- `01_SOURCE_IMPLANTEE/MDL_Ynor_Framework/_00_YNOR_COMMAND_CENTER`





- `01_SOURCE_IMPLANTEE/MDL_Ynor_Framework/_ARCHIVES_LOGIQUE_MDL`
...
### 2. Repertoires de distribution





Les paquets de release visibles dans `_00_DISTS_AND_RELEASES` sont:
...
- `MDL_YNOR_GPT_ULTIMATE_UPLOAD_V17`
...
- `ynor_integrity_audit.ps1`





- `YNOR_OPERATIONAL_HANDBOOK.md`





- `YNOR_SALES_PLAYBOOK.md`
...
Les archives internes de logique, d'audit et de generation comprennent notamment:
...
- `export_ynor_audit.py`





- `extract_mdl_knowledge.py`
...
- `ynor_asymptotic_evolution.py`





- `ynor_autonomous_loop.py`
...
- `ynor_cyber_defense.py`





- `ynor_empirical_validator.py`





- `ynor_full_exploitation.py`





- `ynor_hyper_retention.py`





- `ynor_legal_harvester.py`





- `ynor_master_offensive.py`





- `ynor_metacognitive_layer.py`





- `ynor_military_protocols.py`
...
- `ynor_paradox_relapse.py`





- `ynor_plot_latency.py`





- `ynor_quantum_core.py`





- `ynor_resilience_test.py`
...
## Rewrites Sym?trie R?cursive





### 5. Re-ecriture sym?trie r?cursive
...
### 6. Re-ecriture sym?trie r?cursive bulk
...
### 7. Re-ecriture JSON sym?trie r?cursive
...
### 8. PDFs latex sym?trie r?cursive augmentes
...
- Une seule entree de reference par paquet.





- Les doublons logiques restent des alias documentes, pas des sources principales.





- Les artefacts techniques de travail restent internes et ne doivent pas etre confondus avec les exports de diffusion.
...
Ce manifeste doit rester aligne avec la normalisation canonique et la liste blanche de diffusion.
