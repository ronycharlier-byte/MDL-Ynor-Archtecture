...
# MIROIR TEXTUEL - mdl_ynor_ultimate_benchmark_v3.py

Source : MDL_Ynor_Framework\_08_EXPERIMENTS_AND_DEMOS\mdl_ynor_ultimate_benchmark_v3.py
Taille : 7938 octets
SHA256 : c6e7d228ffede388191b125fc6c3a27964b8f8e69c01f963f4847e0a67814339
...
class MDL_Ultimate_Benchmark:
 ...
 self.knowledge_file = os.path.join(06_D_PRIME_MIROIR_C_PRIME_VALIDATION_TESTS_V3_PY_7DFE70.md")
 self.total_duration = 0
 
 def run_all_checks(self):
 print(" [MDL YNOR] DÉMARRAGE DU BENCHMARK le modèle canonique (CORPUS COMPLET)")
 print("-" * 60)
 ...
 report_file = os.path.join(06_D_PRIME_MIROIR_C_PRIME_VALIDATION_TESTS_V3_PY_7DFE70.md")
