...
Chaque log de reference contient exactement quêtre champs:
...
06_D_PRIME_ROOT_STATUS_CANONICAL_V11_13_0_SOURCE_UNIFIED_MANIFESTE_ENTREE_HUB_NAVIGATION_05_C_PRIME_VALIDATION_TESTS.md`, `03_C_MOTEURS_ET_DEPLOIEMENT/riemann_engine.py`, configuration numerique `n_points=500`, `u_max=5.0`, `seed=42`.

Moteur: `03_C_MOTEURS_ET_DEPLOIEMENT/riemann_engine.py`

Output: `mu=0.999998` (convergence spectrale cible), `status=CONVERGENCE_validéTED`, energies extraites par diagonalisation spectrale.
...
../07_A_PRIME_ARCHIVES_ET_RELEASES/MDL_YNOR_V7_1_DISTRIBUTION/97_Z_ARCHIVES_PRIME_ARCHIVES_RELEASES_MDL_YNOR_V7_1_DISTRIBUTION_YNOR_QUANTUM_GRAVITY_QFT_V11_5.md`, cadre Dirac-Hilbert.
...
06_D_PRIME_ROOT_STATUS_CANONICAL_V11_13_0_SOURCE_UNIFIED_MANIFESTE_ENTREE_HUB_NAVIGATION_05_C_PRIME_VALIDATION_TESTS.md`, `04_X_NOYAU_MEMOIRE/YNOR_MARKET_DYNAMICS_NEXUS/ynor_market_bridge.py`, etat de marche, sentiment, news et fundamentals.
