...
- **ALPHA (Value)**: Not just benchmark outperformance, but **Information Gain** per unit of compute. Derived from Sharpe Ratios and Prediction Hautement Reproductibles.
...
- **Signal**: "Prediction Hautement Reproductible" detection (Standard deviation of GARCH-Var vs. Realized-Var).
