...
class DissipativeField:
    ...
    L'espace total d'tat H_tot est la somme directe des espaces des sous-systèmes.
...
class CriticalNetwork:
    ...
    Reprsente une hirarchie ou un graphe orient de systèmes dissipatifs qui peuvent propager des "mutations"
