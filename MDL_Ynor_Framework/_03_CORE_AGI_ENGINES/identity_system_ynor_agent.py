...
class IdentityVector:
    ...
    def update(self, experience_reward):
        ...
        # Modifie l'IdentitProfonde selon le feedback Ynor

        if experience_reward > 0:

            # Succs : L'agent devient plus rigoureux/efficient
            ...
            # Échec : L'agent comprend qu'il doit explorer plus (Curiosit)
...
class IdentitarianYnorAgent:
    ...
    def bias_decision(self, options):
        ...
        # Le Meta-Controller prend en compte l'Identitpour trancher valeurs gales
...
def simulate_identity_drift():
    ...
    for _ in range(10):
        ...
        agent.identity.update(experience_reward=-1.0) # Reward ngatif
    ...
    print("\n--- Phase 2: Succs & Hyper-Optimisation ---")
