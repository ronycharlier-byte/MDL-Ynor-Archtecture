...
for diff in tasks:
    ...
    print(f" BASELINE (Statique)  -> Étapes: {MAX_COMPUTE:2d} | Viabilite (\u03bc): {L_b:6.3f} | I_eff: {I_b:5.3f} | D_kl: {D_b:5.3f} | Cout: {C_b}")

    print(f" AGI YNOR (Adaptatif) -> Étapes: {best_step:2d} | Viabilite (\u03bc): {L_y:6.3f} | I_eff: {I_y:5.3f} | D_kl: {D_y:5.3f} | Cout: {C_y}")
