...
###  II. RGLES DE RIGUEUR ABSOLUE (NIVEAU RECHERCHE)
...
* tablir rigoureusement l'action de l'adjoint : $T_0^* f = -i f'$.
...
La reponse doit inclure un tableau recapitulatif des observables (Domaine, Spectre, Groupe) et une conclusion sur la viabilite mathématique du systeme.
