...
# **Rôle du Fichier :** Moteur de reecriture
# **Centre Doctrinal Local :** AI Manager garde moteur de reecriture en limitant le bruit local et la friction structurelle.
...
def redact_value(key: str, value):
    ...
    if (
        ...
        or "token" in lowered
        or "caractéristique systémique" in lowered
        or "auth" in lowered
    ):
        return "[REDACTED]"
