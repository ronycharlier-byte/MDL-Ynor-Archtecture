...
$entries = @(
    ...
    @{ Source = "FRACTAL_CHIASTE_UNIVERSEL\05_C_PRIME_validéTION_ET_TESTS\00_NODE.md"; Dest = "05Cprime_NODE.md" },
    @{ Source = "FRACTAL_CHIASTE_UNIVERSEL\05_C_PRIME_validéTION_ET_TESTS\04_INDEX\index.json"; Dest = "05Cprime_index.json" },
    @{ Source = "FRACTAL_CHIASTE_UNIVERSEL\05_C_PRIME_validéTION_ET_TESTS\01_SOURCE_IMPLANTEE\MDL_Ynor_Framework\tests\test_shareable_mu_audit.py"; Dest = "05Cprime_test_shareable_mu_audit.py" }
)
