...
L'existence de solutions pour toute somme paire $2m > 2$ est démontrée par l'analyse spectrale de l'opérateur dipôle $D_{2m}$ sur l'espace de Hilbert $\ell^2(\mathbb{P})$. La marge $\mu_{Goldbach}$ agit ici comme un régulateur de la densité des nÅ“uds premiers.
