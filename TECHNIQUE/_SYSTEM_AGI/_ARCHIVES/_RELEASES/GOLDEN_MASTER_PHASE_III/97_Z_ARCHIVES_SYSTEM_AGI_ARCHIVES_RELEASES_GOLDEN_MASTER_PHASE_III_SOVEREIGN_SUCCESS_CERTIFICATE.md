...
nominal coherence ($D_{KL} \to 0$) leads to infinite structural inertia $\kappa$, causing systemic collapse. Stability is maintained via local stochastic noise ($D_{KL} > 0$).
