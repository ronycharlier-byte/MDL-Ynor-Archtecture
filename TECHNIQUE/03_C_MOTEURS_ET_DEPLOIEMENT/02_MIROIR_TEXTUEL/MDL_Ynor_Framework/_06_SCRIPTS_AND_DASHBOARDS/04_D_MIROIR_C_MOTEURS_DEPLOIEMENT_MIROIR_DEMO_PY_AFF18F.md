...
if test_btn:
 ...
 ../../../../02_B_THEORIE_ET_PREUVES/06_REECRITURE_CHIASTIQUE_BULK/MDL_Ynor_Framework/_01_THEORY_AND_PAPERS/03_C_FORMALISME_B_THEORIE_PREUVES_REECRITURE_TEX_FRACTALE_EA6145.md(f'<div class="metric-card"><small>DISSIPATION STEP</small><br><span class="metric-val">{len(ynor_chunks)}</span></div>', unsafe_allow_html=True)
