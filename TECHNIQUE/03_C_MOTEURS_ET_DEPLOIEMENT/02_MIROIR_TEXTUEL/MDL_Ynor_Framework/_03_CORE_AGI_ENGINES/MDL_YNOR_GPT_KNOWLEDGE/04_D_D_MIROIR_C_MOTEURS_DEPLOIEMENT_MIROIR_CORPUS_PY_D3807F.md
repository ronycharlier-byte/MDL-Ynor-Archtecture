...
SYNC_PLAN = [
 {
 "src": os.path.join(04_D_D_MIROIR_C_MOTEURS_DEPLOIEMENT_MIROIR_ARCHITECTURE_PY_E47232.md"),
 "targets": [
 os.path.join(04_D_D_MIROIR_C_MOTEURS_DEPLOIEMENT_MIROIR_KNOWLEDGE_PY_8629E7.md"),
 os.path.join(04_D_D_MIROIR_C_MOTEURS_DEPLOIEMENT_MIROIR_KNOWLEDGE_PY_8629E7.md")
 ]
 },
 {
 ...
 {
 "src": os.path.join(04_D_D_MIROIR_C_MOTEURS_DEPLOIEMENT_MIROIR_API_PY_063868.md"),
 "targets": [
 os.path.join(04_D_D_MIROIR_C_MOTEURS_DEPLOIEMENT_MIROIR_API_PY_063868.md"),
 os.path.join(04_D_D_MIROIR_C_MOTEURS_DEPLOIEMENT_MIROIR_KNOWLEDGE_PY_8629E7.md")
 ]
 }
]
