...
def get_ai_reconstruction_strategy(mu, state, is_metacognitive=False, history=None):
 prompt_prefix = "[DIRECTIVE prioritéIRE]" if not is_metacognitive else "[ALERTE METACOGNITIVE]"
...
class UnifiedMDLProcessor:
 ...
 """
 log_file = os.path.join("logs", "04_D_MIROIR_C_MOTEURS_DEPLOIEMENT_MIROIR_API_PY_063868.md")
